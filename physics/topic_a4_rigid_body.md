...
### Torque
- **Torque** ($\tau$): the rotational counterpart of force; it quantifies how effectively a force causes angular acceleration about a pivot
...
### Moment of Inertia
- **Moment of inertia** ($I$): the rotational analog of mass—how strongly an object resists changes to its spinning motion
- For point masses: $I = \sum m_i r_i^2$
- Its value depends not just on the total mass but on how that mass is spread relative to the rotation axis—mass farther from the axis contributes more
...
- A rolling object carries both translational and rotational kinetic energy simultaneously: $E_k = \frac{1}{2}mv^2 + \frac{1}{2}I\omega^2$

### Angular Momentum
- $L = I\omega$ (for rotation about a fixed axis)
- Conservation of angular momentum: with no external torque acting, the product $I\omega$ stays fixed—pulling mass inward spins the system faster
- Examples: ice skater spinning, collapsing star

### Equilibrium
- Static equilibrium: $\sum F = 0$ and $\sum \tau = 0$
- Both conditions must hold simultaneously: zero net force prevents translational acceleration; zero net torque prevents rotational acceleration
